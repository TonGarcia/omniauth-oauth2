  ...
  module Strategies
    ...
    protected
      ...
      def build_access_token
        ...
        input_params = {:redirect_uri => callback_url}.merge(token_params.to_hash(:symbolize_keys => true))
        input_params = input_params.merge({client_id: options['client_id'], client_secret: options['client_secret']}) if callback_url.index('linkedin')
        client.auth_code.get_token(verifier, input_params, deep_symbolize(options.auth_token_params))
      end
